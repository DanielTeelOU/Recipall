...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.csi3450.myapp.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.csi3450.myapp.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.csi3450.myapp.domain.User.class.getName());
            createCache(cm, com.csi3450.myapp.domain.Authority.class.getName());
            createCache(cm, com.csi3450.myapp.domain.User.class.getName() + ".authorities");
