...
public class IngredientResourceIT {
     ...
     *
     * @see com.csi3450.myapp.repository.search.IngredientSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createIngredient() throws Exception {
        ...
        assertThat(testIngredient.getImageURL()).isEqualTo(DEFAULT_IMAGE_URL);
    ...
    public void updateIngredient() throws Exception {
        ...
        assertThat(testIngredient.getImageURL()).isEqualTo(UPDATED_IMAGE_URL);
